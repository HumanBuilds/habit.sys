...
export const EmptyState: React.FC = () => {
    return (
        <motion.div
            ...
            className="border-2 border-dashed border-[rgba(0,0,0,0.3)] w-full p-8 flex flex-col items-center justify-center text-center gap-4 bg-[rgba(0,0,0,0.02)]"
        >
            ...
            <div className="h-px w-16 bg-[rgba(0,0,0,0.2)] my-2"></div>
